  ...
  return (
    <footer className="bg-gray-900 border-t border-gray-800 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* DEĞİŞİKLİK: md:grid-cols-4 yerine md:grid-cols-5 yaptık ki yeni kolona yer açılsın */}
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 lg:gap-12 mb-16">
          {/* 1. Kolon: Marka (2 birim yer kaplar) */}
          ...
          {/* 3. Kolon: Güvenlik (YENİ) */}
          <div>
            <h3 className="font-bold text-white mb-6">Güvenlik</h3>
            <ul className="space-y-4 text-sm text-gray-400">
              <li>
                {/* Topluluk Kuralları buraya eklendi */}
                <Link
